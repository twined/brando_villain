...
require.register("autosize/dist/autosize.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "autosize");
  (function() {
    /*!
	Autosize 3.0.17
	license: MIT
...
require.register("backbone/backbone.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "backbone");
  (function() {
    //     Backbone.js 1.3.3
...
require.register("block-elements/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "block-elements");
  (function() {
    /**
...
require.register("collapse-whitespace/lib/whitespace.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "collapse-whitespace");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/BackendConnector.js", function(exports, require, module) {
...
require.register("i18next/dist/commonjs/CacheConnector.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/EventEmitter.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/Interpolator.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/LanguageUtils.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/PluralResolver.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/ResourceStore.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/Translator.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/compatibility/v1.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/defaults.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/i18next.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/logger.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/dist/commonjs/postProcessor.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    "use strict";
...
require.register("i18next/dist/commonjs/utils.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
    'use strict';
...
require.register("i18next/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "i18next");
  (function() {
...
require.register("sweetalert/lib/modules/default-params.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "sweetalert");
  (function() {
    'use strict';
...
require.register("sweetalert/lib/modules/handle-click.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "sweetalert");
  (function() {
    'use strict';
...
require.register("sweetalert/lib/modules/handle-dom.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "sweetalert");
  (function() {
    'use strict';
...
require.register("sweetalert/lib/modules/handle-key.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "sweetalert");
  (function() {
    'use strict';
...
require.register("sweetalert/lib/modules/handle-swal-dom.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "sweetalert");
  (function() {
    'use strict';
...
require.register("sweetalert/lib/modules/injected-html.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "sweetalert");
  (function() {
    "use strict";
...
require.register("sweetalert/lib/modules/set-params.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "sweetalert");
  (function() {
    'use strict';
...
require.register("sweetalert/lib/modules/utils.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "sweetalert");
  (function() {
    'use strict';
...
require.register("sweetalert/lib/sweetalert.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "sweetalert");
  (function() {
    'use strict';
...
require.register("to-markdown/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"jsdom":false}, "to-markdown");
  (function() {
    /*
...
require.register("to-markdown/lib/gfm-converters.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"jsdom":false}, "to-markdown");
  (function() {
    'use strict'
...
require.register("to-markdown/lib/html-parser.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"jsdom":false}, "to-markdown");
  (function() {
    /*
...
require.register("to-markdown/lib/md-converters.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {"jsdom":false}, "to-markdown");
  (function() {
    'use strict'
...
require.register("void-elements/index.js", function(exports, require, module) {
  require = __makeRelativeRequire(require, {}, "void-elements");
  (function() {
    /**
...
require.register("alerts.js", function(exports, require, module) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.alertPrompt = exports.alertWarning = exports.alertSuccess = exports.alertInfo = exports.alertError = undefined;
...
function alertError(text) {
  (0, _sweetalert2.default)({
    text: text, type: 'error', title: ''
  });
}

function alertInfo(text) {
  (0, _sweetalert2.default)({
    text: text, type: 'info', title: ''
  });
}

function alertSuccess(text) {
  (0, _sweetalert2.default)({
    text: text, type: 'success', title: ''
  });
}

function alertWarning(text) {
  (0, _sweetalert2.default)({
    text: text, type: 'warning', title: ''
  });
}

function alertPrompt(text, callback) {
  (0, _sweetalert2.default)({
    text: text, type: 'input', title: ''
  }, callback);
}
...
require.register("block.js", function(exports, require, module) {
'use strict';
...
var Block = _backbone2.default.View.extend({
  el: null,
  tagName: 'div',
  ...
  addToPathName: function addToPathName(relativeUrl) {
  ...
  destroy: function destroy() {
    ...
    this.remove();
    _backbone2.default.View.prototype.remove.call(this);
  },
  onClickDelete: function onClickDelete(e) {
    this.deleteBlock();
    e.stopPropagation();
  },
  onClickMove: function onClickMove(e) {
    e.stopPropagation();
  },
  ...
  onPaste: function onPaste(e) {
    ...
    if (e && e.originalEvent.clipboardData && e.originalEvent.clipboardData.getData) {
      var types = '';
      var clipboardTypes = e.originalEvent.clipboardData.types;

      if (_jquery2.default.isArray(clipboardTypes)) {
        for (var i = 0; i < clipboardTypes.length; i += 1) {
  ...
  getIdFromBlockStore: function getIdFromBlockStore() {
    return this.editor.blockStore.getId();
  },
  doRenderCallback: function doRenderCallback() {},
  ...
  setDataProperty: function setDataProperty(prop, value) {
  ...
  refreshContentBlock: function refreshContentBlock() {
    var block = this.renderContentBlockHtml();
    this.$content.html((0, _jquery2.default)(block).html());
  ...
  clearSetup: function clearSetup() {
    this.$setup.empty();
  },
  ...
  getTextBlockInner: function getTextBlockInner() {
  ...
  showSetup: function showSetup() {
    var iHeight = this.$inner.height();
    var iWidth = this.$inner.width();
    var $button = this.$('.villain-action-button-setup');
...
require.register("blocks/blockquote.js", function(exports, require, module) {
'use strict';
...
var Blockquote = _block2.default.extend({
  ...
  renderContentBlockHtml: function renderContentBlockHtml() {
    ...
    return this.template({
      content: _markup2.default.toHTML(text),
      cite: this.data.cite
    });
  },

  renderEmpty: function renderEmpty() {
    var blockTemplate = this.template({
      content: 'quote',
      cite: 'author'
    });
    var actionsTemplate = this.actionsTemplate();
  ...
  getJSON: function getJSON() {
    var quote = this.$content.find('blockquote')[0].outerHTML;
    var cite = (0, _jquery2.default)('cite', this.$content).html();
    var text = _markup2.default.toMD(quote);
    var json = {
      type: this.type,
      data: {
        text: text,
...
require.register("blocks/columns.js", function(exports, require, module) {
'use strict';
...
var Columns = _block2.default.extend({
  ...
  getColumns: function getColumns(filter) {
  ...
  createColumns: function createColumns($row, data, store) {
    for (var i = 0; i <= data.length - 1; i += 1) {
      ...
      for (var j = 0; j < columnData.length; j += 1) {
  ...
  parseColumns: function parseColumns(columns) {
    var self = this;
    var json = {
      type: this.type,
      data: []
    ...
    columns.each(function reduceColumns() {
      var blocksData = self.parseBlocks(this);

      json.data.push({
        class: (0, _jquery2.default)(this).attr('class'),
        data: blocksData
      });
    });
  ...
  parseBlocks: function parseBlocks(blocks) {
    var blocksData = [];
    var self = this;

    (0, _jquery2.default)(blocks).children('.villain-block-wrapper').each(function parseAndPushBlocks() {
      // loop through all blocks inside this column
      var json = self.parseBlock(this);
      blocksData.push(json);
    });

    return blocksData;
  },
  parseBlock: function parseBlock(block) {
    if ((0, _jquery2.default)(block).attr('data-block-type') === 'columns') {
      var id = (0, _jquery2.default)(block).attr('data-block-id');
      var subCols = (0, _jquery2.default)('#villain-column-row-' + id, (0, _jquery2.default)(block)).children();
      return this.parseColumns(subCols);
    }

    var blockStore = (0, _jquery2.default)(block).attr('data-blockstore');
    var blockId = (0, _jquery2.default)(block).attr('data-block-id');
    var blockObj = this.editor.blockStore.getBlockById(blockStore, blockId);
    var blockJson = blockObj.getJSON();
  ...
  setup: function setup() {
    ...
    if (!this.hasData()) {
      ...
      this.$setup.on('keyup', 'input#villain-columns-number-' + this.dataId, function (e) {
  ...
  updateColumnCount: function updateColumnCount(e) {
    var self = this;
    var columnCount = (0, _jquery2.default)(e.target).val();
    ...
    this.$setup.on('click', 'button#villain-columns-apply-' + this.dataId, function (ev) {
      self.applyColumnCount(ev);
    });
  },
  applyColumnCount: function applyColumnCount(e) {
    e.preventDefault();
    var columnCount = this.$('input#villain-columns-number-' + this.dataId).val();

    for (var i = 1; i < parseInt(columnCount, 10) + 1; i += 1) {
      var columnClass = this.$('input[name="villain-column-width-' + i + '"]').val();
...
require.register("blocks/divider.js", function(exports, require, module) {
'use strict';
...
require.register("blocks/gmap.js", function(exports, require, module) {
'use strict';
...
var Gmap = _block2.default.extend({
  ...
  buildString: function buildString(mapUrl) {
    var match = void 0;
    var data = {};

    _underscore2.default.each(this.providers, function loopProviders(provider, index) {
      match = provider.regex.exec(mapUrl);

      if (match !== null && !_underscore2.default.isUndefined(match[1])) {
        data = {
          source: index,
          embed_url: match[1]
        };
    ...
    if (!{}.hasOwnProperty.call(data, 'source')) {
      (0, _alerts.alertError)('Feil format på embed.');
      return false;
    }
  ...
  renderEmpty: function renderEmpty() {
    var blockTemplate = this.template({ content: '' });
    var actionsTemplate = this.actionsTemplate();
    var wrapperTemplate = this.wrapperTemplate({
      content: blockTemplate,
      actions: actionsTemplate
...
require.register("blocks/header.js", function(exports, require, module) {
'use strict';
...
var Header = _block2.default.extend({
  ...
  setup: function setup() {
    ...
    var headerSizeRadios = _html2.default.createRadios(this.editor.i18n.t('header:header_size'), 'header-size-' + this.dataId, [{ name: 'H1', val: 1 }, { name: 'H2', val: 2 }, { name: 'H3', val: 3 }, { name: 'H4', val: 4 }, { name: 'H5', val: 5 }, { name: 'H6', val: 6 }], level, [{
      ev: 'change',
      fn: function fn(e) {
  ...
  getData: function getData() {
    var data = this.data;
    data.text = _markup2.default.toMD(this.getTextBlock().html()).trim();
    return data;
  },
  getJSON: function getJSON() {
    var data = this.getData();
...
require.register("blocks/html.js", function(exports, require, module) {
'use strict';
...
require.register("blocks/image.js", function(exports, require, module) {
'use strict';
...
var Image = _block2.default.extend({
  ...
  renderEmpty: function renderEmpty() {
    var blockTemplate = this.template({ url: 'http://placehold.it/1150x400' });
    var actionsTemplate = this.actionsTemplate();
    var wrapperTemplate = this.wrapperTemplate({
      content: blockTemplate,
      actions: actionsTemplate
  ...
  onUploadClickAfterDrop: function onUploadClickAfterDrop(e) {
    var _this2 = this;
    ...
    _jquery2.default.ajax({
      ...
      xhr: function xhr() {
        var customXhr = _jquery2.default.ajaxSettings.xhr();
    ...
    }).done(_jquery2.default.proxy(function uploadCallback(retData) {
      var _this = this;
      ...
      if (retData.status === '200') {
        (function () {
          ...
          _this.$setup.find('.villain-image-dropper-upload').remove();
          _this.$setup.find('.villain-image-dropper').remove();

          if ({}.hasOwnProperty.call(retData, 'image')) {
            var imageData = retData.image;
            var $image = (0, _jquery2.default)('<img src="' + imageData.src + '" />');
            _this.$setup.append($image);
          ...
          if ({}.hasOwnProperty.call(retData, 'form')) {
            (function () {
              var inputsHtml = '';
              var inputTemplate = _underscore2.default.template(['<label><%= label %></label>', '<input type="<%= type %>" ', '       value="<%= value %>" ', '       name="<%= name %>"', '/>'].join('\n'));
              for (var i = 0; i < retData.form.fields.length; i += 1) {
                var field = retData.form.fields[i];
              ...
              var formTemplate = _underscore2.default.template(['<form method="<%= method %>" ', '      action="<%= action %>" ', '      class="villain-form" ', '      name="<%= name %>"', '>', '<%= inputs %>', '</form>'].join('\n'));
              ...
              var $submitButton = (0, _jquery2.default)('<input type="submit" name="' + retData.form.name + '-submit" value="OK" />');
              ...
              $submitButton.on('click', function submitClicked(ev) {
                ...
                _jquery2.default.ajax({
                  ...
                  processData: false,
                  dataType: 'json'
                }).done(_jquery2.default.proxy(function (attrsData) {
                  if (attrsData.status === 200) {
                    // set the image title and credits as data
                    var _json = self.getData();
                    _json.title = attrsData.title;
                    _json.credits = attrsData.credits;
                    _json.link = '';
                    self.setData(_json);
              ...
              _this.$setup.append($form);
            })();
          }
        })();
      }
    }, this)).fail(_jquery2.default.proxy(function () {
      // Failed during upload.
      (0, _alerts.alertError)(_this2.editor.i18n.t('errors:image_server_error'));
    }, this)).always(_jquery2.default.proxy(function () {}));
    this.done();
    return true;
  },
  progressHandlingFunction: function progressHandlingFunction(e) {
  ...
  onDropImage: function onDropImage(e) {
    e.preventDefault();
    this.$('.villain-image-dropper i').removeClass('drop-hover');

    var dataTransfer = e.originalEvent.dataTransfer;
    var file = dataTransfer.files[0];
    var urlAPI = this.getUrlAPI();
  ...
  setup: function setup() {
    ...
    if (!this.hasData()) {
      ...
      (function () {
        ...
        var $radios = _html2.default.createRadios(_this3.editor.i18n.t('images:size'), 'imagesize', sizes, data.url, [{
          ev: 'change',
          fn: function fn(e) {
            _this3.setUrl((0, _jquery2.default)(e.target).val());
          }
        }]);

        $form.append($radios);
        _this3.$setup.append($form);
  ...
  onImageBrowseButton: function onImageBrowseButton(e) {
    var _this4 = this;
    ...
    _jquery2.default.ajax({
      ...
      var $images = (0, _jquery2.default)('<div />');

      for (var i = 0; i < data.images.length; i += 1) {
        var img = data.images[i];
        var $storeImg = (0, _jquery2.default)('<img src="' + img.thumb + '" />');
        $storeImg.data('sizes', img.sizes).data('large', img.src).data('title', img.title).data('credits', img.credits);
        $images.append($storeImg);
      }
      $images.on('click', 'img', _jquery2.default.proxy(function setDataOnClick(ev) {
        this.setData({
          url: (0, _jquery2.default)(ev.target).data('large'),
          title: (0, _jquery2.default)(ev.target).data('title'),
          credits: (0, _jquery2.default)(ev.target).data('credits'),
          sizes: (0, _jquery2.default)(ev.target).data('sizes')
        });
        this.getData();
        this.refreshContentBlock();
        this.hideSetup();
      ...
      _this4.$setup.html('');
      _this4.$setup.append('\n        <div class="villain-message success">' + _this4.editor.i18n.t('images:click_image_to_insert') + '</div>\n      ');
      _this4.$setup.append($images);
      _this4.done();
      return true;
    }, this)).fail(function () {
      (0, _alerts.alertError)(_this4.editor.i18n.t('errors:image_server_connection_failed'));
      _this4.done();
      return false;
    });
    return true;
  },
  onUploadImagesButton: function onUploadImagesButton(e) {
    ...
    for (var i = 0; i < files.length; i += 1) {
      ...
      fileList.push(['<div class="three">', '<div class="center-cropped" style="background-image: url(', urlAPI.createObjectURL(f), ');"></div>', '</div>'].join('\n'));
    }

    var listHTML = '<div style="margin-top: 10px;" class="wrapper"><div class="row">';
    for (var x = 0; x < fileList.length; x += 1) {
      if (x && x % 4 === 0) {
        // add row
...
require.register("blocks/list.js", function(exports, require, module) {
'use strict';
...
var List = _block2.default.extend({
  ...
  renderEditorHtml: function renderEditorHtml() {
    var blockTemplate = this.template({
      content: (0, _marked2.default)(this.data.text)
    });
    var actionsTemplate = this.actionsTemplate();
    var wrapperTemplate = this.wrapperTemplate({
      content: blockTemplate,
  ...
  getJSON: function getJSON() {
    var textNode = this.getTextBlock().html().replace(/<\/li>/mg, '\n').replace(/<\/?[^>]+(>|$)/g, '').replace(/^(.+)$/mg, ' - $1');
    return {
      type: this.type,
      data: {
        text: textNode
...
require.register("blocks/markdown.js", function(exports, require, module) {
'use strict';
...
require.register("blocks/slideshow.js", function(exports, require, module) {
'use strict';
...
var Slideshow = _block2.default.extend({
  ...
  renderContentBlockHtml: function renderContentBlockHtml() {
    var images = this.renderDataImages();
    return this.template({
      content: images
    });
  },
  renderDataImages: function renderDataImages() {
    var data = this.getData();
    if (_underscore2.default.isUndefined(data.images)) {
      return '';
    }
  ...
  getAllImageseries: function getAllImageseries() {
    var self = this;
    ...
    _jquery2.default.ajax({
      ...
      if (data.status === '200') {
        ...
        if (!_underscore2.default.isUndefined(self.data.imageseries)) {
          $select.val(self.data.imageseries).change();
        }
      }
    }));
  },
      ...
      if (data.status === '200') {
        (function () {
          ...
          if (self.$setup.find('.imageserie-size-select').length > 0) {
            ...
            // add size dropdown
            var sizeSelect = '<label for="imageserie-size">Str:</label>' + '<select class="imageserie-size-select" ' + '        name="imageserie-size"></select>';
            self.$setup.append(sizeSelect);
          }

          var $sizeSelect = self.$setup.find('.imageserie-size-select');
          $sizeSelect.html('');
          $sizeSelect.append(self.buildOptions(data.sizes, true));

          if (!_underscore2.default.isUndefined(self.data.size)) {
            $sizeSelect.val(self.data.size).change();
            json.size = self.data.size;
          }

          $sizeSelect.on('change', function sizeSelectChangeCallback() {
            json.size = (0, _jquery2.default)(this).val();
            self.hideSetup();
          });
  ...
  buildOptions: function buildOptions(values, placeholder) {
    var html = void 0;
  ...
  setup: function setup() {
    ...
    if (!this.hasData()) {
      ...
      var _select = '<select class="imageserie-select" name="imageserie"></select>';
      this.$setup.append((0, _jquery2.default)('\n        <label for="imageserie">\n          ' + this.editor.i18n.t('slides:imageserie') + '\n        </label>\n        ' + _select + '\n      '));

      var _$select = this.$setup.find('.imageserie-select');
      _$select.on('change', function imageSeriesSelectChangeCallbackWithData() {
        self.getImageseries((0, _jquery2.default)(this).val());
      });
...
require.register("blocks/text.js", function(exports, require, module) {
'use strict';
...
require.register("blocks/video.js", function(exports, require, module) {
'use strict';
...
var Video = _block2.default.extend({
  ...
  onVideoSetupClick: function onVideoSetupClick(e) {
    ...
    if (!_underscore2.default.isURI(videoUrl)) {
      return;
    }

    var embedString = this.buildString(videoUrl);

    this.$content.html(embedString);
    this.hideSetup();
  },
  buildString: function buildString(videoUrl) {
    var _this = this;

    var match = void 0;
    var data = void 0;

    _underscore2.default.each(this.providers, function (provider, index) {
    ...
    return this.providers[data.source].html.replace('{{protocol}}', window.location.protocol).replace('{{remote_id}}', data.remote_id).replace('{{width}}', '100%'); // for videos that can't resize automatically like vine
  },
  renderEditorHtml: function renderEditorHtml() {
    if (!{}.hasOwnProperty.call(this.providers, this.data.source)) {
      return false;
    ...
    var embedString = this.providers[this.data.source].html.replace('{{protocol}}', window.location.protocol).replace('{{remote_id}}', this.data.remote_id).replace('{{width}}', '100%'); // for videos that can't resize automatically like vine
...
require.register("editor.js", function(exports, require, module) {
'use strict';
...
var _registry = require('./stores/registry');
...
var Editor = _backbone2.default.View.extend({
  ...
  initialize: function initialize(options) {
    ...
    this.blockRegistry = new _registry2.default(this, options.defaultBlocks || [], options.extraBlocks || []);
    this.browser = this.getBrowser();

    this.$textArea = (0, _jquery2.default)(options.textArea) || this.textArea;
  ...
  setOptions: function setOptions(options) {
    if (_underscore2.default.isUndefined(options.imageSeries) || _underscore2.default.isUndefined(options.baseURL)) {
  ...
  render: function render() {
    ...
    for (var i = 0; i <= this.data.length - 1; i += 1) {
      var blockJson = this.data[i];
      var BlockClass = this.blockRegistry.getBlockClassByType(blockJson.type);
      if (BlockClass !== false) {
        var block = new BlockClass({
          editor: this,
          data: blockJson.data,
        ...
        throw new _error2.default('Villain: No class found for type: ' + blockJson.type);
      }
    }
    return this;
  },
  ...
  organizeMode: function organizeMode() {
    ...
    (0, _jquery2.default)('.organize .villain-content').hide();
  },
  getJSON: function getJSON() {
    var self = this;
    var json = [];

    this.$('.villain-block-wrapper').each(function pushEachBlockWrapper() {
      // check the main block store for the id. if it's not there
      // it probably belongs to a superblock
      var block = self.blockStore.getBlockById('main', (0, _jquery2.default)(this).data('block-id'));
      if (block !== false) {
        var blockJson = block.getJSON();
        json.push(blockJson);
      }
    });

    var ret = JSON.stringify(json, undefined, 2);

    return ret !== '[]' ? ret : '';
  },
  onDragEnterDroppable: function onDragEnterDroppable(e) {
    (0, _jquery2.default)('.villain-add-block-button', e.currentTarget).addClass('drop-hover');
    e.preventDefault();
    e.stopPropagation();
  },
  onDragLeaveDroppable: function onDragLeaveDroppable(e) {
    (0, _jquery2.default)('.villain-add-block-button', e.currentTarget).removeClass('drop-hover');
    e.preventDefault();
    e.stopPropagation();
  },
  onDragOverDroppable: function onDragOverDroppable(e) {
    e.preventDefault();
    e.stopPropagation();
  },
  onDropDroppable: function onDropDroppable(e) {
    var target = e.currentTarget;
    if ((0, _jquery2.default)(target).hasClass('villain-droppable') !== true) {
      e.preventDefault();
      e.stopPropagation();
      return false;
    }

    var sourceId = e.originalEvent.dataTransfer.getData('text/plain');
    var $source = (0, _jquery2.default)('[data-block-id=' + sourceId + ']');
    var $sourceAdd = $source.next();

    (0, _jquery2.default)('.villain-add-block-button', target).removeClass('drop-hover');
    ...
    $source.insertAfter((0, _jquery2.default)(target));
    var oldBlockStore = $source.attr('data-blockstore');
    var newBlockStore = (0, _jquery2.default)(target).attr('data-blockstore');

    // get the block from old blockstore
    var block = this.blockStore.getBlockById(oldBlockStore, sourceId);
  ...
  onDropTextblock: function onDropTextblock(e) {
    (0, _jquery2.default)(e.currentTarget).closest('.villain-block-wrapper').shake();
    e.preventDefault();
    e.stopPropagation();
    return false;
  },
  processPaste: function processPaste(pastedFrag) {
    var cleanHtml = void 0;
    if (pastedFrag.match(/(class="?Mso|style="[^"]*\bmso\-|w:WordDocument)/gi)) {
      cleanHtml = this.wordClean(pastedFrag);
      cleanHtml = this.clean((0, _jquery2.default)('<div>').append(cleanHtml).html(), false, true);
  ...
  wordClean: function wordClean(html) {
    // Keep only body.
    var cleanedHtml = html;

    if (html.indexOf('<body') >= 0) {
      cleanedHtml = cleanedHtml.replace(/[.\s\S\w\W<>]*<body[^>]*>([.\s\S\w\W<>]*)<\/body>[.\s\S\w\W<>]*/g, '$1');
    }

    // Single item list.
    cleanedHtml = cleanedHtml.replace(/<p(.*?)class="?'?MsoListParagraph"?'?([\s\S]*?)>([\s\S]*?)<\/p>/gi, '<ul><li><p>$3</p></li></ul>');

    // List start.
    cleanedHtml = cleanedHtml.replace(/<p(.*?)class="?'?MsoListParagraphCxSpFirst"?'?([\s\S]*?)>([\s\S]*?)<\/p>/gi, '<ul><li><p>$3</p></li>');

    // List middle.
    cleanedHtml = cleanedHtml.replace(/<p(.*?)class="?'?MsoListParagraphCxSpMiddle"?'?([\s\S]*?)>([\s\S]*?)<\/p>/gi, '<li><p>$3</p></li>');

    // List end.
    cleanedHtml = cleanedHtml.replace(/<p(.*?)class="?'?MsoListParagraphCxSpLast"?'?([\s\S]*?)>([\s\S]*?)<\/p>/gi, '<li><p>$3</p></li></ul>');

    // Clean list bullets.
    cleanedHtml = cleanedHtml.replace(/<span([^<]*?)style="?'?mso-list:Ignore"?'?([\s\S]*?)>([\s\S]*?)<span/gi, '<span><span');
    ...
    var wordTags = ['style', 'script', 'applet', 'embed', 'noframes', 'noscript'];
    for (var i = 0; i < wordTags.length; i += 1) {
      var regex = new RegExp('<' + wordTags[i] + '.*?' + wordTags[i] + '(.*?)>', 'gi');
  ...
  clean: function clean(html) {
    ...
    // Remove script tag.
    var cleanedHtml = html.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, '');

    // Remove all tags not in allowed tags.
    var atReg = new RegExp('<\\/?((?!(?:' + allowedTags.join('|') + '))\\w+)[^>]*?>', 'gi');
    cleanedHtml = cleanedHtml.replace(atReg, '');

    // Remove all attributes not in allowed attrs.
    var aaReg = new RegExp('( (?!(?:' + allowedAttrs.join('|') + '))[a-zA-Z0-9-_]+)=((?:.(?!\\s+(?:\\S+)=|[>]|(\\/>)))+.)', 'gi');

    cleanedHtml = cleanedHtml.replace(aaReg, '');

    // Clean style.
    var styleReg = new RegExp('style=("[a-zA-Z0-9:;\\.\\s\\(\\)\\-\\,!\\/\'%]*"|' + '\'[a-zA-Z0-9:;\\.\\s\\(\\)\\-\\,!\\/"%]*\')', 'gi');
    cleanedHtml = cleanedHtml.replace(styleReg, '');

    // Remove the class.
    var $div = (0, _jquery2.default)('<div>').append(cleanedHtml);
    $div.find('[class]:not([class^="fr-"])').each(function (index, el) {
      (0, _jquery2.default)(el).removeAttr('class');
    });
  ...
  plainPasteClean: function plainPasteClean(html) {
    var $div = (0, _jquery2.default)('<div>').html(html);

    $div.find('h1, h2, h3, h4, h5, h6, pre, blockquote').each(function (i, el) {
      (0, _jquery2.default)(el).replaceWith('<p>' + (0, _jquery2.default)(el).html() + '</p>');
    });

    var replacePlain = function replacePlain(i, el) {
      (0, _jquery2.default)(el).replaceWith((0, _jquery2.default)(el).html());
    };
  ...
  removeEmptyTags: function removeEmptyTags(html) {
    var $div = (0, _jquery2.default)('<div>').html(html);
    var emptyTags = $div.find('*:empty:not(br, img, td, th)');

    while (emptyTags.length) {
      for (var i = 0; i < emptyTags.length; i += 1) {
        (0, _jquery2.default)(emptyTags[i]).remove();
      }
    ...
    $div.find('> div').each(function (i, div) {
      (0, _jquery2.default)(div).replaceWith((0, _jquery2.default)(div).html() + '<br />');
    });

    // Remove divs.
    var divs = $div.find('div');
    while (divs.length) {
      for (var _i = 0; _i < divs.length; _i += 1) {
        var $el = (0, _jquery2.default)(divs[_i]);
...
require.register("errors/error.js", function(exports, require, module) {
'use strict';
...
var VillainError = function (_ExtendableError) {
  _inherits(VillainError, _ExtendableError);

  function VillainError(m) {
    _classCallCheck(this, VillainError);

    return _possibleConstructorReturn(this, (VillainError.__proto__ || Object.getPrototypeOf(VillainError)).call(this, 'Villain >> ' + m));
  }
...
var LOCALE_NB = {
  errors: {
    image_server_connection_failed: 'Kunne ikke koble til bildeserver',
    upload_failed: 'Opplasting feilet',
    no_images_found: 'Ingen bilder fantes.',
    image_server_error: 'Feil fra bildeserver under opplasting'
  },

  columns: {
    number_of_columns: 'Antall kolonner',
    setup_class_name: 'Kolonne {{columnNumber}} klassenavn (col-md-6...)',
    setup_columns: 'Sett opp kolonner'
  },

  header: {
    size: 'Størrelse på overskrift',
    anchor: 'Anker'
  },

  map: {
    setup_instructions: 'Lim inn embed-link fra Google Maps'
  },

  slides: {
    imageserie: 'Bildeserie'
  },
  ...
  video: {
    setup_instructions: 'Lim inn link til youtube eller vimeo, f.eks '
  },

  images: {
    click_image_to_insert: 'Klikk på bildet du vil sette inn',
    pull_in_image_to_upload: 'Dra bildet du vil laste opp hit',
    browse_server_for_images: 'Hent bilde fra server',
    upload_and_save: 'Last opp og lagre',
    upload_success: 'Bildet er lastet opp',
    size: 'Størrelse',
    title: 'Tittel',
...
var Plus = _backbone2.default.View.extend({
  el: null,
  tagName: 'div',
  ...
  initialize: function initialize(options) {
    ...
    this.$el.attr('data-blockstore', this.store);
    this.$el.attr('id', _underscore2.default.uniqueId('villain-plus-'));
    this.render();
  },
  render: function render() {
  ...
  onClickBlockButton: function onClickBlockButton(e) {
    ...
    var blockType = $button.data('type');
    var blockStore = this.store;
    var BlockClass = this.editor.blockRegistry.getBlockClassByType(blockType);
  ...
  onClickAddBlock: function onClickAddBlock(e) {
    e.preventDefault();

    var $addBlockButton = (0, _jquery2.default)(e.currentTarget);

    $addBlockButton.hide();

    var blockId = $addBlockButton.parent().data('after-block-id');
    var blockSelection = this.blockSelectionTemplate({
  ...
  getButtons: function getButtons(id) {
    ...
    try {
      for (var _iterator = this.editor.blockRegistry.registry[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
require.register("stores/registry.js", function(exports, require, module) {
'use strict';
...
var DEFAULT_BLOCKS = [{
  ...
  name: 'Header',
  cls: _header2.default
}, {
  name: 'Blockquote',
  cls: _blockquote2.default
}, {
  name: 'List',
  cls: _list2.default
}, {
  ...
  name: 'Divider',
  cls: _divider2.default
}, {
  name: 'Html',
  cls: _html2.default
}, {
  name: 'Markdown',
  cls: _markdown2.default
}, {
  name: 'Columns',
  cls: _columns2.default
}];

var BlockRegistry = function () {
  function BlockRegistry(editor, defaultBlocks, extraBlocks) {
    _classCallCheck(this, BlockRegistry);
  ...
  _createClass(BlockRegistry, [{
    key: 'addExtraBlocks',
    value: function addExtraBlocks(extraBlocks) {
    ...
    value: function checkBlocks() {
      for (var i = 0; i < this.registry.length; i += 1) {
        var b = this.registry[i];

        if (_underscore2.default.isUndefined(b.cls)) {
          throw new _error2.default('Villain: Missing block source for ' + b.name + '! Please ensure it is included.');
        }
      }
    }
  }, {
    key: 'getBlockClassByType',
    value: function getBlockClassByType(type) {
      var b = _underscore2.default.find(this.registry, { name: (0, _underscore2.default)(type).capitalize() });
      if (b) {
        return b.cls;
      }
...
exports.default = BlockRegistry;
});

;require.register("stores/store.js", function(exports, require, module) {
'use strict';
...
var BlockStore = function () {
  ...
  _createClass(BlockStore, [{
    ...
    key: 'getBlockById',
    value: function getBlockById(storeName, id) {
      var block = this.stores[storeName].find(function (b) {
        return parseInt(b.id, 10) === parseInt(id, 10);
      });
    ...
    key: 'add',
    value: function add(store, id, blockObject) {
    ...
    key: 'del',
    value: function del(store, id) {
      this.stores[store] = _underscore2.default.filter(this.stores[store], function (block) {
        return parseInt(block.id, 10) !== parseInt(id, 10);
      });
    }
  }, {
    key: 'delStore',
    value: function delStore(store) {
      // iterate all blocks
      this.stores[store].forEach(function (element) {
        return element.object.destroy();
      });
      this.stores[store] = [];

      var index = this.storeIndex.indexOf(store);
...
var Markup = function () {
    ...
    _createClass(Markup, null, [{
        key: 'toMD',
        value: function toMD(html) {
            html = (0, _toMarkdown2.default)(html);
            html = html.replace(/&nbsp;/g, ' ');
        ...
        key: 'toHTML',
        value: function toHTML(markdown, type) {
            // MD -> HTML
            if (_underscore2.default.isUndefined(markdown)) {
                return "";
            }

            type = _underscore2.default.classify(type);

            var html = markdown,
                shouldWrap = type === 'Text';

            if (_underscore2.default.isUndefined(shouldWrap)) {
                shouldWrap = false;
            }
            ...
            // with a slash.
            html = _underscore2.default.reverse(_underscore2.default.reverse(html).replace(/_(?!\\)((_\\|[^_])*)_(?=$|[^\\])/gm, function (match, p1) {
...
require.register("utils/mixins.js", function(exports, require, module) {
'use strict';
...
_underscore2.default.mixin({
  ...
  classify: function classify(str) {
    return _underscore2.default.titleize(String(str).replace(/[\W_]/g, ' ')).replace(/\s/g, '');
  },

  classifyList: function classifyList(a) {
    return _underscore2.default.map(a, function (i) {
      return _underscore2.default.classify(i);
    });
  },
  ...
  underscored: function underscored(str) {
    return _underscore2.default.trim(str).replace(/([a-z\d])([A-Z]+)/g, '$1_$2').replace(/[-\s]+/g, '_').toLowerCase();
  },
  ...
  flattern: function flattern(obj) {
    var x = {};
    _underscore2.default.each(obj, function (a, b) {
      x[_underscore2.default.isArray(obj) ? a : b] = true;
    });
    return x;
  },

  to_slug: function to_slug(str) {
    return str.toLowerCase().replace(/[^\w ]+/g, '').replace(/ +/g, '-');
  }
});

_jquery2.default.fn.visible = function () {
  return this.css('visibility', 'visible');
};

_jquery2.default.fn.invisible = function () {
  return this.css('visibility', 'hidden');
};

_jquery2.default.fn.visibilityToggle = function () {
  return this.css('visibility', function (i, visibility) {
    return visibility == 'visible' ? 'hidden' : 'visible';
  });
};

_jquery2.default.fn.caretToEnd = function () {
  var range, selection;
...
_jquery2.default.fn.flash = function (duration, iterations) {
...
_jquery2.default.fn.shake = function (shakes, distance, duration) {
  shakes = shakes || 3;
  distance = distance || 10;
  duration = duration || 300;
  this.each(function () {
    (0, _jquery2.default)(this).css('position', 'relative');
    for (var x = 1; x <= shakes; x++) {
      (0, _jquery2.default)(this).animate({
        left: distance * -1
      }, duration / shakes / 4).animate({
        left: distance
      }, duration / shakes / 2).animate({
        left: 0
      }, duration / shakes / 4);
    }
  });
  ...
  var methods = {
    init: function init(options) {
      var opts = $.extend({}, $.fn.loadingOverlay.defaults, options),
          ...
          overlay = '<div class="' + opts.overlayClass + '">' + '<p class="' + opts.spinnerClass + '">' + '<span class="' + opts.iconClass + '"></span>' + '<span class="' + opts.textClass + '">' + opts.loadingText + '</span>' + '</p></div>';
...
require.register("villain.js", function(exports, require, module) {
'use strict';
...
require.alias("collapse-whitespace/lib/whitespace.js", "collapse-whitespace");
require.alias("jquery/dist/jquery.js", "jquery");
require.alias("marked/lib/marked.js", "marked");
require.alias("process/browser.js", "process");
require.alias("sweetalert/lib/sweetalert.js", "sweetalert");
...
/* jshint ignore:end */
;require('villain');
//# sourceMappingURL=villain.all.js.map